...
public class GiftView extends StackPane {
    ...
    public GiftView(List<String> players, List<Integer> handCardIds, AssetRegistry registry) {
        ...
        Label title = new Label("Gift");
        title.getStyleClass().add("effect-response-title");

        Label cardLabel = new Label("Pick two cards to gift");
        ...
        Label playerLabel = new Label("Pick who will receive them");
